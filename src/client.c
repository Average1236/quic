...
xqc_mini_cli_init_args(xqc_mini_cli_args_t *args)
{
    ...
    strncpy(args->env_cfg.log_path, CLI_LOG_PATH, sizeof(args->env_cfg.log_path));
    strncpy(args->env_cfg.out_file_dir, CLI_OUT_DIR, sizeof(args->env_cfg.out_file_dir));
    strncpy(args->env_cfg.key_out_path, CLI_KEY_PATH, sizeof(args->env_cfg.key_out_path));
